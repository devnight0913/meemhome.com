<div class="row">
    ...
    <div class="col-3">
        <a href="https://twitter.com/intent/tweet?text={{ $item->url }}" target="_blank"
            class="btn btn-light d-flex align-items-center w-100 justify-content-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" class="hero-icon me-md-2">
                <path fill="#03A9F4"
    ...
    <div class="col-3">
        <a href="mailto:?Subject={{ $item->name }}&body={{ $item->url }}" target="_blank"
            class="btn btn-light d-flex align-items-center w-100 justify-content-center">
    ...
    <div class="col-3">
        <a href="whatsapp://send?text={{ $item->url }}" target="_blank"
            class="btn btn-light d-flex align-items-center w-100 justify-content-center">
